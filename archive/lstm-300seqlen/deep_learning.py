...
# data = Data_Stream('cyc-asda0', load_truth=True, higher_freq=False, no_cache=True)
# # plt.plot(data.gps[:, 1], data.gps[:, 2])
# # plt.show()
# data = Data_Stream('cyc-asda-rev0', load_truth=True, higher_freq=False, no_cache=True)
# # plt.plot(data.gps[:, 1], data.gps[:, 2])
# # plt.show()
# data = Data_Stream('cyc-tuto0', load_truth=True, higher_freq=False, no_cache=True)
# # plt.plot(data.gps[:, 1], data.gps[:, 2])
# # plt.show()
# data = Data_Stream('cyc-tuto-rev0', load_truth=True, higher_freq=False, no_cache=True)
# # plt.plot(data.gps[:, 1], data.gps[:, 2])
# # plt.show()
...
model = Sequential()
model.add(LSTM(units=128, return_sequences=True, input_shape=(None, x_dim,)))
model.add(LSTM(units=128, return_sequences=True, input_shape=(None, x_dim,)))
model.add(LSTM(units=128, return_sequences=True, input_shape=(None, x_dim,)))
model.add(LSTM(units=128, return_sequences=True, input_shape=(None, x_dim,)))
model.add(LSTM(units=128, return_sequences=True, input_shape=(None, x_dim,)))
